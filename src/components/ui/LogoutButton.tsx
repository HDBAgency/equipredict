...
export default function LogoutButton() {
  ...
  return (
    <div className="flex items-center gap-2">
      <Link
        href="/compte"
        className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-black text-white border border-white/20 hover:border-eq-green transition-all"
