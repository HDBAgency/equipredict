...
const LAYOUT: Cfg[] = [
  { top: 0,   left: '0%',   width: 385, rotate: -4,  dur: 5.6, delay: 0,   z: 1 },
  { top: 55,  left: '29%',  width: 318, rotate:  3,  dur: 6.4, delay: 0.9, z: 2 },
  { top: 8,   right: '0%',  width: 358, rotate: -2,  dur: 4.9, delay: 1.6, z: 1 },
  { top: 420, left: '1%',   width: 348, rotate:  2,  dur: 7.1, delay: 0.3, z: 2 },
  { top: 445, left: '32%',  width: 332, rotate: -5,  dur: 5.3, delay: 1.3, z: 3 },
  { top: 435, right: '0%',  width: 312, rotate:  5,  dur: 6.9, delay: 2.1, z: 1 },
]
