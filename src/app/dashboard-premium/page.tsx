...
import { PremiumPaywallGate } from '@/components/dashboard/PremiumPaywallGate'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-bold text-white" style={{ background: 'linear-gradient(135deg, #064E3B, #10B981)' }}>
              PREMIUM
            </span>
          </div>
        ...
        <Suspense fallback={
          ...
          <PremiumRacesGrid activeType={activeType} />
        </Suspense>
