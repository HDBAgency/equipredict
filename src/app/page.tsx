  ...
  return (
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative overflow-hidden -mt-16 min-h-[500px] sm:min-h-[700px] lg:min-h-[1080px]">
        ...
        <div
          className="absolute inset-0 flex flex-col items-center justify-start px-4 sm:px-6 lg:px-8 text-center pt-[130px] sm:pt-[160px] lg:pt-[160px]"
          style={{ zIndex: 3 }}
        >
      ...
      <section className="relative hidden lg:block" style={{ height: '1080px' }}>
        ...
        />
        <p className="absolute text-gray-600 text-xs text-center" style={{ top: 'calc(50% + 455px)', left: '50%', transform: 'translateX(-50%)', whiteSpace: 'nowrap' }}>
          Application PMU
        </p>
      ...
      {/* Partenaires */}
      <section className="pt-16 sm:pt-24 lg:pt-60 pb-10 overflow-hidden w-full">
      ...
      <section className="pt-16 sm:pt-24 lg:pt-60 pb-20">
        <div className="text-center mb-0 sm:mb-16 px-4">
          <ScrollRevealHeading line1="LES COURSES" line2="EN VIDÉO" className="!mb-0 sm:!mb-6" />
        </div>
        <VideoCarousel videos={VIDEOS} />
      </section>

      {/* Testimonials */}
      <section className="pt-10 sm:pt-24 lg:pt-40 pb-32 sm:pb-24 relative z-10">
